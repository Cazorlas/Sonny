...
namespace SonnyApplication.Tests
{
    ...
    public abstract class SonnyRevitTestBase
    {
        ...
        protected UIDocument? OpenDocument(string filePath)
        {
            return UIApp!.OpenAndActivateDocument(filePath) ;
        }
        ...
        {
            return new FilteredElementCollector(doc).OfClass(typeof( Dimension ))
                .GetElementCount() ;
        }
